...
public class UploadPdf extends AppCompatActivity
{
	...
	private EditText pdfTitleInput;
    ...
    protected void onCreate(Bundle savedInstanceState)
	{
		...
		pdfTitleInput = findViewById(R.id.pdfTitleInput);
		pdfTitleOutput = findViewById(R.id.pdfTitleOutput);
									...
									public void onFailure(Exception e)
											{
												...
												e.printStackTrace();
												Toast.makeText(UploadPdf.this, "An error occured. Exception: ", Toast.LENGTH_LONG).show();
											}
	...
	private void uploadData(String downloadUrl)
			{
				...
				databaseReference.child("pdf").child(uniqueKey).setValue(data).addOnCompleteListener(UploadPdf.this, new OnCompleteListener<Void>()
						{
							@Override
									...
									public void onFailure(Exception e)
											{
												progressDialog.dismiss();
												e.printStackTrace();
												Toast.makeText(UploadPdf.this, "Failed to upload pdf. Exception: " + e, Toast.LENGTH_LONG).show();
											}
